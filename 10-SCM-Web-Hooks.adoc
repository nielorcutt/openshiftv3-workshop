...
* We will use the forked repository from the previous lab. Please fork from here https://github.com/RedHatWorkshops/bluegreen  
...
* Simply add a comment to change the file.
* Commit the file.
